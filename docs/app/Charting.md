...
**Source:** `app/src/components/shared/ChartContainer.tsx`
...
**Source:** `app/src/components/shared/TimeRangeSelector.tsx`
...
See [[Design System]] for the complete `CHART_THEME` object, series colors, tooltip styling, and domain color maps.
