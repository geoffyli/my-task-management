...
**Source:** `app/server/db/store.ts` — extraction functions and core key definitions.
...
| Status | select | `status` | Values: Not Started, In Progress, Done, Cancelled, Blocked. Default: "Not Started" |
