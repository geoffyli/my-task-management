...
Each task carries three date fields that together tell the complete planning-to-completion story:

```
Assigned Date → Started Date → Closed Date
(current plan)   (execution)    (completion)
```
