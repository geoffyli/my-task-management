  ...
  return (
    ...
    >
      ...
      <a
        ...
        className="mt-3 inline-block rounded-[6px] bg-[rgba(255,255,255,0.06)] px-3 py-1.5 text-[12px] font-[510] text-foreground-secondary hover:bg-[rgba(255,255,255,0.1)] hover:text-foreground transition-colors"
      >
        Open in Notion ↗
      </a>
    </div>
